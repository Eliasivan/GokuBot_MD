process.env['NODE_TLS_REJECT_UNAUTHORIZED'] = '0'; 
 ...
 /* Creditos a Angel (https://wa.me/51982110760) */ 
 ...
 const connectionOptions = { 
   ...
   browser: ['𝗚𝗢𝗞𝗨BOT_MD', 'Safari', '2.0.0'], 
   version, 
 ...
 global.reloadHandler = async function(restatConn) { 
   ...
   conn.welcome = '*╔══════════════*\n╟☆ @subject\n*╠══════════════*\n╟☆ @user\n╟ꕥ 𝗕𝗶𝗲𝗻𝘃𝗲𝗻𝗶𝗱𝗼/𝗮 \n╟☆ 𝗥𝗲𝗰𝘂𝗲𝗿𝗱𝗮 𝗹𝗮𝘀 𝗿𝗲𝗴𝗹𝗮𝘀 𝗽𝗮𝗿𝗮 𝗻𝗼 𝘀𝗲𝗿 𝗲𝗹𝗶𝗺𝗶𝗻𝗮𝗱𝗼(𝗮) 𝗱𝗲𝗹 𝗴𝗿𝘂:\n╟☆ 𝗘𝘅𝗰𝗲𝗹𝗲𝗻𝘁𝗲 𝗲𝘀𝘁𝗮𝗱𝗶𝗮 𝘆 𝗯𝘂𝗲𝗻𝗮 𝘀𝘂𝗲𝗿𝘁𝗲!!\n*╚══════════════*'; 
   conn.bye = '*╔══════════════*\n╟☆ @user\n╟♲︎︎︎ 𝗔𝗱𝗶𝗼𝘀 𝘆 𝗻𝗼 𝗿𝗲𝗴𝗿𝗲𝘀𝗲𝘀 𝗻𝘂𝗻𝗰𝗮 \n╟☆ 𝗡𝗮𝗱𝗶𝗲 𝗹𝗼 𝗲𝘅𝘁𝗿𝗮𝗻̃𝗮𝗿𝗮 𝗽𝗼𝗿 𝘀𝗲𝗿 𝗺𝗮𝗹𝗮 𝗽𝗲𝗿𝘀𝗼𝗻𝗮😃 \n*╚══════════════*'; 
   conn.spromote = '[↪️] @user 𝐏𝐞𝐫𝐟𝐞𝐜𝐭𝐨,𝐀𝐡𝐨𝐫𝐚 𝐞𝐬 𝐚𝐝𝐦𝐢𝐧 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝗳𝗲𝗹𝗶𝗰𝗶𝗱𝗮𝗱𝗲𝗱𝗲𝘀.'; 
   conn.sdemote = '[↪️] @user 𝐋𝐨 𝐬𝐢𝐞𝐧𝐭𝐨,𝐘𝐚 𝐧𝐨 𝐞𝐫𝐞𝐬 𝐚𝐝𝐦𝐢𝐧 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝗺𝗮𝗹𝗮 𝘀𝘂𝗲𝗿𝘁𝗲 𝗹𝗼 𝗰𝗶𝗲𝗻𝘁𝗼.'; 
 ...
 */ 
 ...
 setInterval(async () => { 
   ...
   const bio = `♥︎☆𝗚𝗼𝗸𝘂𝗕𝗼𝘁_𝗠𝗗☆♥︎ |♥︎☆𝗼𝘄𝗻𝗲𝗿☆♥︎|♥︎☆𝗔𝗡𝗚𝗘𝗟-𝗢𝗙𝗖☆♥︎ |♥︎☆𝗖𝗿𝗲𝗮𝗱𝗼𝗿☆♥︎┃𝗧𝗶𝗺𝗲${uptime}`; 
