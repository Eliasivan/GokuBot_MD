...
global.owner = [
  ...
  ['50558124470', 'Ender creador', true],
  [''],
  [''],
  ['', '', true],
  ['', '', true],
...
global.md = 'https://github.com/AngelPeruFachero/GokuBot_MD';
global.gukubot = 'https://github.com/AngelPeruFachero/GokuBot_MD';
...
watchFile(file, () => {
  unwatchFile(file);
  console.log(chalk.redBright('Update \'config.gb\''));
